...
<body onload="init()">
 		...
 		<c:set var="memberBean" value="${requestScope.memberInfo }" />
        ...
        <form method="post" action="MemberModifyAction.do" 
            ...
            <table>
                <tr>
                    <td id="title">아이디</td>
                    <td id="title" class="left"><%=memberBean.getId() %></td>
                </tr>
                <tr>
                    <td id="title">비밀번호</td>
                    <td class="left">
            ...
            <table>
                ...
                <tr>
                    <td id="title">이름</td>
                    <td class="left"><%=memberBean.getName() %></td>
                </tr>
                    
                <tr>
                    <td id="title">성별</td>
                    <td class="left"><%=memberBean.getGender()%></td>
                </tr>
